...
/**
 * Class Autozpro_Elementor_Blog
 */
class Autozpro_Elementor_Post_Grid extends Elementor\Widget_Base {

    public function get_name() {
        return 'autozpro-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'autozpro');
    }
    ...
    public function get_script_depends() {
        return ['autozpro-elementor-posts-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'autozpro'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'autozpro'),
                    'post_title' => esc_html__('Title', 'autozpro'),
        ...
        $this->add_control(
            'tag_operator',
            [
                'label'     => esc_html__('Tags Operator', 'autozpro'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'IN',
                'options'   => [
                    'AND'    => esc_html__('AND', 'autozpro'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-style-1' => esc_html__('Blog Style 1', 'autozpro'),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'prefix_class' => 'autozpro-post-style-grid-',
            ]
        );
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'autozpro'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'autozpro'),
                    'prev_next'             => esc_html__('Previous/Next', 'autozpro'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'autozpro') . ' + ' . esc_html__('Previous/Next', 'autozpro'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'autozpro'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'autozpro'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'condition' => [
                    'pagination_type' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'autozpro'),
                'default'   => esc_html__('&laquo; Previous', 'autozpro'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'autozpro'),
                'default'   => esc_html__('Next &raquo;', 'autozpro'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'autozpro') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'autozpro'); ?>">
...
$widgets_manager->register(new Autozpro_Elementor_Post_Grid());
