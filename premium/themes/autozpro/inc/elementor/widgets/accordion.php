 ...
 * @since 1.0.0
 */
class Autozpro_Elementor_Accordion extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Autozpro Accordion', 'autozpro');
    }
    ...
    public function get_script_depends() {
        return ['autozpro-elementor-accordion'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_title',
            [
                'label' => esc_html__('Accordion', 'autozpro'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Accordion Title', 'autozpro'),
                'dynamic'     => [
                    'active' => true,
                ],
                'label_block' => true,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => esc_html__('Accordion Content', 'autozpro'),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => esc_html__('Accordion Items', 'autozpro'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => esc_html__('Accordion #1', 'autozpro'),
                    ...
                    [
                        'tab_title'   => esc_html__('Accordion #2', 'autozpro'),
                        'tab_content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'autozpro'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Active Icon', 'autozpro'),
                'type'             => Controls_Manager::ICONS,
        ...
        $this->add_control(
            'faq_schema',
            [
                'label'     => esc_html__('FAQ Schema', 'autozpro'),
        ...
        $this->add_control(
            'tab_active_color',
            [
                'label'     => esc_html__('Active Color', 'autozpro'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Autozpro_Elementor_Accordion());