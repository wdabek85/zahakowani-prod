 ...
 *
 * @extends    Walker
 * @class        Autozpro_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Autozpro_Product_Brand_List_Walker', false)) :

	class Autozpro_Product_Brand_List_Walker extends Walker {
