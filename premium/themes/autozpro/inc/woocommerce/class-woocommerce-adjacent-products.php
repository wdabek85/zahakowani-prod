<?php
/**
 * Autozpro WooCommerce Adjacent Products Class
 *
 * @package  autozpro
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Autozpro_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Autozpro WooCommerce Adjacent Products Class
	 */
	class Autozpro_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'autozpro_woocommerce_adjacent_query_args', $args ) );
