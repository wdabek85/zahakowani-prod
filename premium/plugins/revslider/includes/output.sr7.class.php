...
class RevSlider7Output extends RevSliderFunctions {
	...
	public function get_slides(){
		...
		$slides = (!empty($this->slider_v7)) ? $this->slider_v7->get_slides(true, false, $hero) : $this->slider->get_slides(true, false, $hero); //fetch all slides connected to the Slider (no static slide)
