...
<table class="gui-settings-table">
    ...
    <tr>
        ...
        <td class="input-tooltip d-flex-align-center">
            <input name="izi_button_checkout_max_width" type="number" value="<?= get_option("izi_button_checkout_max_width"); ?>" min="220" max="600">
            <div class="input-tooltip-wrapper">
                <img src="<?php echo plugin_dir_url(
                        __FILE__
                    ) .
    ...
    <tr>
        ...
        <td class="input-tooltip d-flex-align-center">
            <input name="izi_button_checkout_min_height" type="number" value="<?= get_option("izi_button_checkout_min_height"); ?>" min="48" max="64">
            <div class="input-tooltip-wrapper">
                <img src="<?php echo plugin_dir_url(
                        __FILE__
                    ) .
