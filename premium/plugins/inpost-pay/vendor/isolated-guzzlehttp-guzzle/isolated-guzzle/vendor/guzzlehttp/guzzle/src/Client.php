...
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\GuzzleHttp\Cookie\CookieJar;
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\GuzzleHttp\Exception\GuzzleException;
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Isolated\Inpost_Pay\Isolated_Guzzlehttp\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
