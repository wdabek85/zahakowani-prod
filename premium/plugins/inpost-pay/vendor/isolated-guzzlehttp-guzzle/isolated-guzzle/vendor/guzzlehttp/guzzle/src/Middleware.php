...
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\GuzzleHttp\Cookie\CookieJarInterface;
...
use Isolated\Inpost_Pay\Isolated_Guzzlehttp\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('Isolated\\Inpost_Pay\\Isolated_Guzzlehttp\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
