...
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Interfaces\Cache_Interface;
...
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Traits\Actions;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Traits\Conditions;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Traits\Events;
class Event_Chain
{
    use Events;
    use Conditions;
