...
namespace Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Traits;

use Exception;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\On;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Save_Post;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Save_Wc_Order_Post;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Add_To_Cart;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Before_Checkout_Form;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Before_Settings;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Before_Shop_Loop_Item;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Before_Single_Product;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Checkout_Page;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Checkout_Update_Order_Meta;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Filter_Price_Html;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Loaded;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_New_Order;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Order_Status_Changed;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Product_Options_General_Product_Data;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Product_Options_Pricing;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Product_Update;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Remove_Cart_Item;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Variation_Create;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wc_Variation_Update;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp_Admin_Footer;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp_Admin_Init;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp_Ajax;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp_Cron_Every_N_Minutes;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp_Footer;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event\Wp_Init;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Event_Chain\Event_Chain;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Presentation\Interfaces\Field_Ajax_Interface;
trait Events
{
    /**
     * @throws Exception
