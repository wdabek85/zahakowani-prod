...
namespace Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Presentation\Woocommerce;
...
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Presentation\Interfaces\Field_Number_Interface;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Presentation\Interfaces\Field_Select_Interface;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Presentation\Interfaces\Field_Text_Area_Interface;
use Isolated\Inpost_Pay\Ilabs\Ilabs_Plugin\Presentation\Interfaces\Field_Text_Interface;
class Field
{
    /**
     * @throws Exception
    ...
    {
        \ob_start();
        woocommerce_wp_checkbox(['desc_tip' => $checkbox->get_desc(), 'name' => $checkbox->get_name(), 'value' => $checkbox->get_value(), 'id' => $checkbox->get_id(), 'label' => $checkbox->get_label()]);
        return \ob_get_clean();
    }
    /**
    ...
    /**
     * @param Field_Text_Area_Interface | Field_Interface
     *     $field_text_Area_Interface
     *
     * @return string
     */
